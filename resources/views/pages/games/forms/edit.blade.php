...
@section('form')
    <div class="row justify-content-start">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Edit "{{$game->title}}" game</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('game.update',['game'=>$game]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input id="title" type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ $game->title }}" required autocomplete="title" autofocus>
                                @error('title')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input id="short_address" type="text" class="form-control @error('short_address') is-invalid @enderror" name="short_address"
                                       value="{{ $game->short_address }}" required autocomplete="short_address" autofocus>
                                @error('short_address')
                                <span class="red" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <textarea class="@error('info') is-invalid @enderror" name="info" id="editor">{{ $game->info }}</textarea>
                                @error('info')
                                <span class="red" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
