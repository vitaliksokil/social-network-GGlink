    ...
    <div class="row justify-content-start">
        <div class="col-md-12">
            <div class="card">
                ...
                @isset($games)
                    <div class="card-body">
                        <form method="POST" action="{{ route('community.update',['community'=>$community]) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="title" type="text"
                                           ...
                                           value="{{ $community->title }}" required autocomplete="title" autofocus>
                                    @error('title')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="short_address" type="text"
                                           ...
                                           name="short_address" value="{{ $community->short_address }}" required
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <textarea class="@error('info') is-invalid @enderror" name="info"
                                              id="editor">{{ $community->info }}</textarea>
                                    @error('info')
                                    <span class="red" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
